...
// $Rev: 92848 $
// File generated on 14.04.2019 18:53:16 from Type Library described below.
...
{
public:
  virtual HRESULT STDMETHODCALLTYPE Run(void) = 0; // [201]
...
TCOMITestLibBez777T<T>::Run(void)
{
  return (*this)->Run();
}
...
// *********************************************************************//
template <class T> HRESULT __fastcall
ITestLibBez777DispT<T>::Run()
{
  _TDispID _dispid(*this, OLETEXT("Run"), DISPID(201));
